...
### Chat Interface
![Chat Interface](YFinance-Chatbot-main/demo_images/chat_interface.png)
*Natural language interface with AI-powered suggestions*

### Candlestick Chart Analysis
![Candlestick Chart](YFinance-Chatbot-main/demo_images/candlestick.png)
*Interactive candlestick charts with detailed metrics*

### Volume Analysis
![Volume Chart](YFinance-Chatbot-main/demo_images/volume.png)
*Trading volume visualization with AI insights*

### Market Overview with News
![Market Overview](YFinance-Chatbot-main/demo_images/market_overview.png)
...
Created by [Saurav Shukla](https://github.com/sauravkshukla)

Repository: [https://github.com/saurav/FinancePilot](https://github.com/sauravkshukla/YFinance-Chatbot)
